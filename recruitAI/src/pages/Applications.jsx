...
const Applications = () => {
  ...
  const { backendUrl, userApplications, userData, fetchUserData, fetchUserApplications } = useContext(AppContext)
          ...
          <tbody>
            {
              userApplications.map((job, index) => true ? (
                <tr key={index}>
                  <td className='py-3 px-4 flex items-center gap-3 border-b'> <img className='w-8 h-8' src={job.companyId.image} alt="" />
